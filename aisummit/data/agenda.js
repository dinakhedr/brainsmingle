 ...
 * Generated 2026-09-08 23:06 · 67 sessions, 0 with a sign-up link.
 *
...
const SIGNAL_AGENDA = [
  ...
  // DAY 2
  // ======================================
  { id: "ses-d2-s1-t1", title: "If You Can't Delegate to AI, You Can't Delegate to People", type: "Session", trackNumber: 1, day: 2, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-018"], bmUrl: null, description: null, special: null, status: "closed" },
  { id: "ses-d2-s1-t2", title: "AI filmmaking and the transformation of creative workflows", type: "Session", trackNumber: 2, day: 2, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-040"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  { id: "ses-d2-s1-t5", title: "DevOps in the AI Era", type: "Panel Discussion", trackNumber: 5, day: 2, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-019","spk-033","spk-034","spk-036"], bmUrl: null, description: null, special: null, status: "closed" },
  { id: "ses-d2-s2-t1", title: "AI in Education: From Hype to Practical Use", type: "Session", trackNumber: 1, day: 2, slot: 2, timeSlot: "19:00", durationMinutes: 60, speakerIds: ["spk-034"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  { id: "ses-d2-s3-t1", title: "AI Taxonomy in Education", type: "Session", trackNumber: 1, day: 2, slot: 3, timeSlot: "20:00", durationMinutes: 60, speakerIds: ["spk-059"], bmUrl: null, description: null, special: null, status: "closed" },
  { id: "ses-d2-s3-t2", title: "AI, Sit Down", type: "Session", trackNumber: 2, day: 2, slot: 3, timeSlot: "20:00", durationMinutes: 60, speakerIds: ["spk-043"], bmUrl: null, description: null, special: null, status: "closed" },
  { id: "ses-d2-s3-t3", title: "How to build your GenAI application", type: "Session", trackNumber: 3, day: 2, slot: 3, timeSlot: "20:00", durationMinutes: 60, speakerIds: ["spk-021"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  { id: "ses-d2-s3-t5", title: "Building Deep Search Agent from Scratch", type: "Session", trackNumber: 5, day: 2, slot: 3, timeSlot: "20:00", durationMinutes: 60, speakerIds: ["spk-005"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  { id: "ses-d4-s1-t4", title: "AI for Product Marketers: What Actually Changes in the Work", type: "Session", trackNumber: 4, day: 4, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-049"], bmUrl: null, description: null, special: null, status: "closed" },
  { id: "ses-d4-s1-t5", title: "AI automation with n8n: Build smarter, faster workflows", type: "Session", trackNumber: 5, day: 4, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-050"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  // DAY 5
  // ======================================
  { id: "ses-d5-s1-t2", title: "Create your first AI video", type: "Session", trackNumber: 2, day: 5, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-041"], bmUrl: null, description: null, special: null, status: "closed" },
  { id: "ses-d5-s1-t3", title: "Democratizing Assessment Centres: AI-Driven Hiring for High-Growth Startups", type: "Session", trackNumber: 3, day: 5, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-054"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  { id: "ses-d5-networking", title: "Daily Speed Networking", type: "Speed Networking", trackNumber: null, day: 5, slot: 5, timeSlot: "22:00", durationMinutes: 60, speakerIds: [], bmUrl: null, description: null, special: "networking", status: "closed" },
  ...
  { id: "ses-d6-s1-t4", title: "Beyond Copilots: Governed Agentic AI for Enterprise Decisions", type: "Session", trackNumber: 4, day: 6, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-008"], bmUrl: null, description: null, special: null, status: "in-progress" },
  { id: "ses-d6-s1-t5", title: null, type: "Session", trackNumber: 5, day: 6, slot: 1, timeSlot: "18:00", durationMinutes: 60, speakerIds: ["spk-032"], bmUrl: null, description: null, special: null, status: "in-progress" },
  ...
  { id: "ses-d6-s2-t5", title: null, type: "Session", trackNumber: 5, day: 6, slot: 2, timeSlot: "19:00", durationMinutes: 60, speakerIds: ["spk-015"], bmUrl: null, description: null, special: null, status: "in-progress" },
  ...
  { id: "ses-d6-s3-t5", title: "AI Infrastructure for Startups & Companies", type: "Session", trackNumber: 5, day: 6, slot: 3, timeSlot: "20:00", durationMinutes: 60, speakerIds: ["spk-060"], bmUrl: null, description: null, special: null, status: "closed" },
  ...
  // DAY 7
  // ======================================
  { id: "ses-d7-networking", title: "Speed Networking Day", type: "Speed Networking", trackNumber: null, day: 7, slot: 1, timeSlot: null, durationMinutes: null, speakerIds: [], bmUrl: null, description: null, special: "networking", status: "closed" }
