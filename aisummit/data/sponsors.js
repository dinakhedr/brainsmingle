...
const SIGNAL_PARTNERS = [
  ...
  { id: "prt-049", order: 614, name: "GADI World", tier: "community", icon: "community", title: "Community Partner in UAE", country: "UAE", countryCode: "AE", confirmed: true, group: "community", logo: "prt-049.png", logoURL: "x", website: "https://gadiworld.com", bmCommunityLink: null, tagline: "MENA-focused Digital Analytics and MarTech solutions provider and community, specializing in E-Commerce and App Growth. From tracking and data foundations to dashboards and marketplace growth, GADI World helps brands across Egypt and the Gulf make smarter, data-driven decisions." },
  ...
  { id: "prt-050", order: 805, name: "GDG on Campus Al-Azhar University", tier: "community", icon: "student", title: "Campus Partner", country: null, countryCode: null, confirmed: true, group: "community", logo: "prt-050.png", logoURL: "x", website: "https://www.facebook.com/GDGCAlAzhar/", bmCommunityLink: null, tagline: "GDG on Campus Al-Azhar University is a student-led tech community dedicated to bridging the gap between academic education and real-world industry demands. Through courses, workshops, events, and hands-on experiences, we equip students with the skills, connections, and confidence they need to enter the job market ready to succeed. Students are at the heart of everything we do — we build a space where they learn, share, and grow together." },
