/* ─── docs-hub-icons.js ───
   SVG icon registry for the Documents Hub.
   Usage: <div class="card-icon" data-icon="puzzle"></div>
   The arrow icon is auto-injected into every .card-arrow element.
*/

const DOC_ICONS = {

    graduation: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-graduation-cap-icon lucide-graduation-cap"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"/></svg>',
    ...
    checkbox: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-check-icon lucide-circle-check"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>',
...
/* Arrow SVG used in every card-arrow */
const ARROW_SVG = '<svg viewBox="0 0 24 24"><path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z" transform="rotate(180 12 12)"/></svg>';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('[data-icon]').forEach(el => {
        ...
        if (DOC_ICONS[key]) {
            el.innerHTML = DOC_ICONS[key];
        }
    });

    // Inject arrow icons
    document.querySelectorAll('.card-arrow').forEach(el => {
        if (!el.querySelector('svg')) {
            el.insertAdjacentHTML('beforeend', ARROW_SVG);
        }
    });
});
